...
JSON schema:
{
  "title": "string",
  "scenes": [
    {"scene_order": 1, "dialogue": "string", "subtitle_text": "string"},
    {"scene_order": 2, "dialogue": "string", "subtitle_text": "string"},
    {"scene_order": 3, "dialogue": "string", "subtitle_text": "string"},
    {"scene_order": 4, "dialogue": "string", "subtitle_text": "string"},
    {"scene_order": 5, "dialogue": "string", "subtitle_text": "string"},
    {"scene_order": 6, "dialogue": "string", "subtitle_text": "string"}
  ]
}
